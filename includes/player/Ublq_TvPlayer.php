...
?>
<?php if ($totalRows_TvPlayers > 0) { // Show if recordset not empty ?>
  <div class="Player_Ublq"><object id="MediaPlayer" width=673 height=480 classid="CLSID:22d6f312-b0f6-11d0-94ab-0080c74c7e95"codebase="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=5,1,52,701" standby="Loading Microsoft Windows Media Player components..."type="application/x-oleobject">
    ...
    <embed type="application/x-mplayer2" pluginspage="http://www.microsoft.com/Windows/Downloads/Contents/Products/MediaPlayer/" src="<?php echo $row_TvPlayers['codes']; ?>" ShowControls="1" ShowAudioControls="1" ShowPositionControls="0" ShowTracker="0" ShowStatusBar="1" ShowDisplay="0" DefaultFrame="" SlideAutostart="1" EnableContextMenu="false" width="673" height="480" ></embed>
    </object>
    <input name="ChannelName" type="hidden" id="ChannelName" value="<?php echo $row_TvPlayers['ChannelName']; ?>" />
  </div>
                ...
                <td width="110"><table width="104" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#002137">
                  <tr>
                    ...
                    <td width="172"><table width="171" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td width="163" height="20" bgcolor="#002137"><div align="left"><span class="text"><?php echo $row_TvPlayers['ChannelName']; ?></span></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              <td width="362" height="32" class="normal_textlinkbold"><table width="362" border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="255"><table border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td height="20" bgcolor="#002137"><div align="left" class="text"><?php echo $row_TvPlayers['daters']; ?></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              ...
              <tr>
                <td width="110"><table width="104" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#002137">
                  <tr>
                    ...
                    <td width="172"><table width="171" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td height="20" bgcolor="#002137"><div align="left"><span class="text"><?php echo $row_TvPlayers['cates']; ?></span></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              <td height="32" class="normal_textlinkbold"><table width="357" border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="250"><table border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td height="20" bgcolor="#002137"><div align="left"><span><a href="http://technorati.com/tags/<?php echo $string = str_replace(' ', '+', $row_TvPlayers['keywds']); ?>" target="_blank" class="textkey"><?php echo $row_TvPlayers['keywds']; ?></a></span></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              ...
              <td height="32" class="normal_textlinkbold"><strong>
                ...
                <table width="362" border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="107"><table width="104" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#002137">
                          <tr>
                            <td height="23" bgcolor="#002137"><div align="left" class="left_menuheading">Embed Url :   : </div></td>
                          </tr>
                    </table></td>
                    <td width="255"><table width="100" border="0" align="left" cellpadding="0" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td bgcolor="#002F4E"><strong>
                              <input name="EmbedCode" type="text" class="embedbar" id="EmbedCode" value="http://www.ublq.com/includes/player/Ublq_TvPlayer.php?ChannelName=<?php echo $string = str_replace(' ', '+', $row_TvPlayers['ChannelName']); ?>" size="42" />
                          </strong></td>
                        </tr>
                    </table></td>
                  </tr>
