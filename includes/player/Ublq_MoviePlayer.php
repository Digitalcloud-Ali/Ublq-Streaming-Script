...
$colname_MoviePlayers = "-1";
if (isset($_GET['ChannelName'])) {
  $colname_MoviePlayers = $_GET['ChannelName'];
}
mysql_select_db($database_Ublq, $Ublq);
$query_MoviePlayers = sprintf("SELECT * FROM mov25ublq WHERE ChannelName = %s", GetSQLValueString($colname_MoviePlayers, "text"));
$MoviePlayers = mysql_query($query_MoviePlayers, $Ublq) or die(mysql_error());
$row_MoviePlayers = mysql_fetch_assoc($MoviePlayers);
$totalRows_MoviePlayers = mysql_num_rows($MoviePlayers);

mysql_free_result($MoviePlayers);
?>
<?php if ($totalRows_MoviePlayers > 0) { // Show if recordset not empty ?>
  
    <input name="ChannelName" type="hidden" id="ChannelName" value="<?php echo $row_MoviePlayers['ChannelName']; ?>" />
    <table width="673" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="480"><div class="Player_Ublq"><?php echo $row_MoviePlayers['codes']; ?></div></td>
      </tr>
    </table>
                ...
                <td width="110"><table width="104" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#002137">
                  <tr>
                    ...
                    <td width="172"><table width="171" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td width="163" height="20" bgcolor="#002137"><div align="left"><span class="text"><?php echo $row_MoviePlayers['ChannelName']; ?></span></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              <td width="362" height="32" class="normal_textlinkbold"><table width="362" border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="255"><table border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td height="20" bgcolor="#002137"><div align="left" class="text"><?php echo $row_MoviePlayers['daters']; ?></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              ...
              <tr>
                <td width="110"><table width="104" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#002137">
                  <tr>
                    ...
                    <td width="172"><table width="171" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td height="20" bgcolor="#002137"><div align="left"><span class="text"><?php echo $row_MoviePlayers['cates']; ?></span></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              <td height="32" class="normal_textlinkbold"><table width="357" border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="250"><table border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                      <tr>
                        <td height="20" bgcolor="#002137"><div align="left"><span><a href="http://technorati.com/tags/<?php echo $string = str_replace(' ', '+', $row_MoviePlayers['keywds']); ?>" target="_blank" class="textkey"><?php echo $row_MoviePlayers['keywds']; ?></a></span></div></td>
                      </tr>
                    </table></td>
                  </tr>
              </table></td>
