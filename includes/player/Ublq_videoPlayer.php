...
$colname_videoPlayers = "-1";
if (isset($_GET['ChannelName'])) {
  $colname_videoPlayers = $_GET['ChannelName'];
}
mysql_select_db($database_Ublq, $Ublq);
$query_videoPlayers = sprintf("SELECT * FROM mov25ublq WHERE ChannelName = %s", GetSQLValueString($colname_videoPlayers, "text"));
$videoPlayers = mysql_query($query_videoPlayers, $Ublq) or die(mysql_error());
$row_videoPlayers = mysql_fetch_assoc($videoPlayers);
$totalRows_videoPlayers = mysql_num_rows($videoPlayers);

mysql_free_result($videoPlayers);
?>
<?php if ($totalRows_videoPlayers > 0) { // Show if recordset not empty ?>
  
    <input name="ChannelName" type="hidden" id="ChannelName" value="<?php echo $row_videoPlayers['ChannelName']; ?>" />
    <table width="673" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="480"><div class="Player_Ublq"><?php echo $row_videoPlayers['codes']; ?></div></td>
      </tr>
    </table>
                ...
                <td width="110"><table width="104" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#002137">
                  <tr>
                    ...
                    <td width="172"><table width="171" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td width="163" height="20" bgcolor="#002137"><div align="left"><span class="text"><?php echo $row_videoPlayers['ChannelName']; ?></span></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              <td width="362" height="32" class="normal_textlinkbold"><table width="362" border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="255"><table border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td height="20" bgcolor="#002137"><div align="left" class="text"><?php echo $row_videoPlayers['daters']; ?></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              ...
              <tr>
                <td width="110"><table width="104" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#002137">
                  <tr>
                    ...
                    <td width="172"><table width="171" border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                        <tr>
                          <td height="20" bgcolor="#002137"><div align="left"><span class="text"><?php echo $row_videoPlayers['cates']; ?></span></div></td>
                        </tr>
                    </table></td>
                  </tr>
              </table></td>
              <td height="32" class="normal_textlinkbold"><table width="357" border="0" align="left" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="250"><table border="0" align="left" cellpadding="3" cellspacing="1" bgcolor="#003E66">
                      <tr>
                        <td height="20" bgcolor="#002137"><div align="left"><span><a href="http://technorati.com/tags/<?php echo $string = str_replace(' ', '+', $row_videoPlayers['keywds']); ?>" target="_blank" class="textkey"><?php echo $row_videoPlayers['keywds']; ?></a></span></div></td>
                      </tr>
                    </table></td>
                  </tr>
              </table></td>
...
<table border='0' cellpadding='0' cellspacing='0'>
	<tr>
		<td width="26"><a href="http://digg.com/submit?phase=2&url=http%3A//www.ublq.com&title=A%20Quality%20Streaming%20Tv%20-%20Radio%20-%20video%20Media%20Site" target="_blank">
		  <div class="div_link"><img border="0" src="/imagine/digg.png" alt="Digg This" title="Digg This" /></div>
		</a></td>
		<td width="26"><a href="http://del.icio.us/post?url=http%3A//www.ublq.com&title=A%20Quality%20Streaming%20Tv%20-%20Radio%20-%20video%20Media%20Site" target="_blank">
		...
		<td width="26"><a href="http://reddit.com/submit?url=http%3A//www.ublq.com&title=A%20Quality%20Streaming%20Tv%20-%20Radio%20-%20video%20Media%20Site" target="_blank">
		  <div class="div_link"><img border="0" src="/imagine/reddit.png" alt="Reddit" title="Reddit" /></div>
		</a></td>
		<td width="26"><a href="http://myweb2.search.yahoo.com/myresults/bookmarklet?u=http%3A//www.ublq.com&=A%20Quality%20Streaming%20Tv%20-%20Radio%20-%20video%20Media%20Site" target="_blank">
		  <div class="div_link"><img border="0" src="/imagine/yahoomyweb.png" alt="YahooMyWeb" title="YahooMyWeb" /></div>
		</a></td>
		<td width="26"><a href="http://www.blinklist.com/index.php?Action=Blink/addblink.php&Description=&Url=http%3A//www.ublq.com&Title=A%20Quality%20Streaming%20Tv%20-%20Radio%20-%20video%20Media%20Site" target="_blank">
