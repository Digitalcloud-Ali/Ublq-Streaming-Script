    ...
    <td valign="top"><table width="1003" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="689" valign="top" bgcolor="#FFFFFF"><table width="888" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="840" height="28" class="headering_black" style="padding-left:6px;">Ublq 2.0 Setting :</td>
              ...
              <table width="897" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="901" height="219" valign="top"><table width="896" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="886" height="283"><div align="center">
                          <table width="898" height="275" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="551" valign="top"><div class="text3"><ol>
                                <li>
                                  <div align="left"><a href="edit_pages.php?ids=1" class="normal_textlink">Edit Tags</a></div>
                                </li>
                                <li>
                                  <div align="left"><a href="edit_pages.php?ids=2" class="normal_textlink">Edit About Us</a><br />
                                  </div>
                                </li>
                                <li>
                                  <div align="left"><a href="edit_pages.php?ids=3" class="normal_textlink">Edit Help</a>&nbsp;</div>
                                </li>
                              </ol></div></td>
                              <td width="347" valign="top"><img src="../imagine/Hot_Dog_Car.png" width="256" height="256" /></td>
                            </tr>
                          </table>
                        </div></td>
                      </tr>
