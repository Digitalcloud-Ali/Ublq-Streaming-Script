...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "InsertTvChannels")) {
  $updateSQL = sprintf("UPDATE mov25ublq SET ChannelName=%s, codes=%s, daters=%s, cates=%s, keywds=%s WHERE ids=%s",
...
$colname_edimov = "-1";
if (isset($_GET['ids'])) {
  $colname_edimov = $_GET['ids'];
}
mysql_select_db($database_Ublq, $Ublq);
$query_edimov = sprintf("SELECT * FROM mov25ublq WHERE ids = %s", GetSQLValueString($colname_edimov, "int"));
$edimov = mysql_query($query_edimov, $Ublq) or die(mysql_error());
$row_edimov = mysql_fetch_assoc($edimov);
$totalRows_edimov = mysql_num_rows($edimov);
?>
  ...
  <tr>
    <td valign="top"><table width="1003" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="689" valign="top" bgcolor="#FFFFFF"><table width="888" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="840" height="28" class="headering_black" style="padding-left:6px;">Edit Movies :</td>
    ...
    <tr>
                  <td width="901" height="219" valign="top"><table width="896" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table border="0" cellpadding="4" cellspacing="0">
                      <tr>
                        ...
                        <td width="303" bgcolor="#FFFFFF"><table width="416" border="0" cellpadding="0" cellspacing="1" bgcolor="#D4D0C8">
                            <tr>
                                <td bgcolor="#21262B"><?php echo $row_edimov['codes']; ?></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Channel Name :</td>
                        <td bgcolor="#FFFFFF"><input name="ChannelName" type="text" class="editbar" id="ChannelName3" value="<?php echo $row_edimov['ChannelName']; ?>" /></td>
                      </tr>
                      <tr>
                        <td bgcolor="#FFFFFF" class="graytext">CodeLink :</td>
                        <td bgcolor="#FFFFFF"><textarea name="codes" cols="80" rows="15" class="editbar" id="codes"><?php echo $row_edimov['codes']; ?></textarea></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Date :</td>
                        <td bgcolor="#FFFFFF"><input name="daters" type="text" class="editbar" id="daters" value="<?php echo $row_edimov['daters']; ?>"/></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Category :</td>
                        <td bgcolor="#FFFFFF"><select name="cates" class="editbar" id="cates">
                          <option selected="selected" value="" <?php if (!(strcmp("", $row_edimov['cates']))) {echo "selected=\"selected\"";} ?>>Select Here</option>
                          <option value="action" <?php if (!(strcmp("action", $row_edimov['cates']))) {echo "selected=\"selected\"";} ?>>Action</option>
                          <option value="children" <?php if (!(strcmp("children", $row_edimov['cates']))) {echo "selected=\"selected\"";} ?>>Children</option>
                          <option value="comedy" <?php if (!(strcmp("comedy", $row_edimov['cates']))) {echo "selected=\"selected\"";} ?>>Comedy</option>
                          <option value="documentary" <?php if (!(strcmp("documentary", $row_edimov['cates']))) {echo "selected=\"selected\"";} ?>>Documentary</option>
                          <option value="drama" <?php if (!(strcmp("drama", $row_edimov['cates']))) {echo "selected=\"selected\"";} ?>>Drama</option>
                          <option value="fantasy" <?php if (!(strcmp("fantasy", $row_edimov['cates']))) {echo "selected=\"selected\"";} ?>>Fantasy</option>
                          <option value="horror" <?php if (!(strcmp("horror", $row_edimov['cates']))) {echo "selected=\"selected\"";} ?>>Horror</option>
                        </select></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Keywords :</td>
                        <td bgcolor="#FFFFFF"><input name="keywds" type="text" class="editbar" id="keywds" value="<?php echo $row_edimov['keywds']; ?>" size="78" maxlength="40" /></td>
                      </tr>
                      <tr>
                    ...
                    <input name="ids" type="hidden" id="ids" value="<?php echo $row_edimov['ids']; ?>" />
