...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE utaggers SET taggers=%s WHERE ids=%s",
                       GetSQLValueString($_POST['taggers'], "text"),
...
$colname_Tagoos = "-1";
if (isset($_GET['ids'])) {
  $colname_Tagoos = $_GET['ids'];
}
mysql_select_db($database_Ublq, $Ublq);
$query_Tagoos = sprintf("SELECT * FROM utaggers WHERE ids = '$request'", GetSQLValueString($colname_Tagoos, "int"));
$Tagoos = mysql_query($query_Tagoos, $Ublq) or die(mysql_error());
$row_Tagoos = mysql_fetch_assoc($Tagoos);
$totalRows_Tagoos = mysql_num_rows($Tagoos);
    ...
    <td valign="top"><table width="1003" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" bgcolor="#FFFFFF"><table width="888" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="840" height="28" class="headering_black" style="padding-left:6px;">Ublq 2.0 Edit Information :</td>
              ...
              <table width="897" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="901" height="219" valign="top"><table width="896" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="886"><div align="center"><table width="600" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="600" height="219" valign="top"><table width="611" border="0" cellpadding="0" cellspacing="0" bgcolor="#002F4E">

                    <tr>
                      <td bgcolor="#FFFFFF"><form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST" style="margin:0px;">
                        <div align="left">
                          <table width="100" border="0" cellpadding="0" cellspacing="1" bgcolor="#002F4E">
                            <tr>
                              <td bgcolor="#FFFFFF"><textarea name="taggers" cols="122" rows="25" class="infobar" id="taggers"><?php echo $row_Tagoos['taggers']; ?></textarea></td>
                              </tr>
                          </table>
                          <input name="button" type="submit" class="searchbutton" id="button" value="Update" />
                          <input type="hidden" name="MM_update" value="form1" />
                          <input name="ids" type="hidden" id="ids" value="<?php echo $row_Tagoos['ids']; ?>" />
</div>
                      </form>                      </td>
                    </tr>
                  </table>                  </td>
                  <td width="213"><img src="../imagine/Mighty Ducks.png" width="256" height="256" /></td>
                </tr>
                <tr>
                  <td valign="top">&nbsp;</td>
                  <td valign="top">&nbsp;</td>
