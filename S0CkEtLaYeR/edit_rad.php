...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "InsertTvChannels")) {
  $updateSQL = sprintf("UPDATE rad24ublq SET ChannelName=%s, codes=%s, daters=%s, cates=%s, keywds=%s WHERE ids=%s",
...
$colname_edirad = "-1";
if (isset($_GET['ids'])) {
  $colname_edirad = $_GET['ids'];
}
mysql_select_db($database_Ublq, $Ublq);
$query_edirad = sprintf("SELECT * FROM rad24ublq WHERE ids = %s", GetSQLValueString($colname_edirad, "int"));
$edirad = mysql_query($query_edirad, $Ublq) or die(mysql_error());
$row_edirad = mysql_fetch_assoc($edirad);
$totalRows_edirad = mysql_num_rows($edirad);
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Edit Radio</title>
  ...
  <tr>
    <td valign="top"><table width="1003" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="689" valign="top" bgcolor="#FFFFFF"><table width="888" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="840" height="28" class="headering_black" style="padding-left:6px;">Edit Radio :</td>
    ...
    <tr>
                  <td width="901" height="219" valign="top"><table width="896" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table border="0" cellpadding="4" cellspacing="0">
                      <tr>
                        ...
                        <td width="303" bgcolor="#FFFFFF"><table width="416" border="0" cellpadding="0" cellspacing="1" bgcolor="#D4D0C8">
                            <tr>
                                <td bgcolor="#21262B"><?php echo $row_edirad['codes']; ?></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Channel Name :</td>
                        <td bgcolor="#FFFFFF"><input name="ChannelName" type="text" class="editbar" id="ChannelName3" value="<?php echo $row_edirad['ChannelName']; ?>" /></td>
                      </tr>
                      <tr>
                        <td bgcolor="#FFFFFF" class="graytext">CodeLink :</td>
                        <td bgcolor="#FFFFFF"><textarea name="codes" cols="80" rows="15" class="editbar" id="codes"><?php echo $row_edirad['codes']; ?></textarea></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Date :</td>
                        <td bgcolor="#FFFFFF"><input name="daters" type="text" class="editbar" id="daters" value="<?php echo $row_edirad['daters']; ?>"/></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Category :</td>
                        <td bgcolor="#FFFFFF"><select name="cates" class="editbar" id="cates">
                          <option selected="selected" value="" <?php if (!(strcmp("", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>Select Here</option>
                          <option value="news" <?php if (!(strcmp("news", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>News</option>
                          <option value="information" <?php if (!(strcmp("information", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>Information</option>
                          <option value="shopping" <?php if (!(strcmp("shopping", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>Shopping</option>
                          <option value="music" <?php if (!(strcmp("music", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>Music</option>
                          <option value="kids" <?php if (!(strcmp("kids", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>Kids</option>
                          <option value="sports" <?php if (!(strcmp("sports", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>Sports</option>
                          <option value="games" <?php if (!(strcmp("games", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>Games</option>
                          <option value="religion" <?php if (!(strcmp("religion", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>Religion</option>
                          <option value="documentary" <?php if (!(strcmp("documentary", $row_edirad['cates']))) {echo "selected=\"selected\"";} ?>>Documentary</option>
                        </select></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Keywords :</td>
                        <td bgcolor="#FFFFFF"><input name="keywds" type="text" class="editbar" id="keywds" value="<?php echo $row_edirad['keywds']; ?>" size="78" maxlength="40" /></td>
                      </tr>
                      <tr>
                    ...
                    <input name="ids" type="hidden" id="ids" value="<?php echo $row_edirad['ids']; ?>" />
