...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "InsertTvChannels")) {
  $updateSQL = sprintf("UPDATE nlq21gam SET ChannelName=%s, codes=%s, daters=%s, cates=%s, keywds=%s WHERE ids=%s",
...
$colname_edigam = "-1";
if (isset($_GET['ids'])) {
  $colname_edigam = $_GET['ids'];
}
mysql_select_db($database_Ublq, $Ublq);
$query_edigam = sprintf("SELECT * FROM nlq21gam WHERE ids = %s", GetSQLValueString($colname_edigam, "int"));
$edigam = mysql_query($query_edigam, $Ublq) or die(mysql_error());
$row_edigam = mysql_fetch_assoc($edigam);
$totalRows_edigam = mysql_num_rows($edigam);
  ...
  <tr>
    <td valign="top"><table width="1003" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="689" valign="top" bgcolor="#FFFFFF"><table width="888" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="840" height="28" class="headering_black" style="padding-left:6px;">Edit Games :</td>
    ...
    <tr>
                  <td width="901" height="219" valign="top"><table width="896" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table border="0" cellpadding="4" cellspacing="0">
                      <tr>
                        ...
                        <td width="303" bgcolor="#FFFFFF"><table width="416" border="0" cellpadding="0" cellspacing="1" bgcolor="#D4D0C8">
                            <tr>
                                <td bgcolor="#21262B"></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Channel Name :</td>
                        <td bgcolor="#FFFFFF"><input name="ChannelName" type="text" class="editbar" id="ChannelName3" value="<?php echo $row_edigam['ChannelName']; ?>" /></td>
                      </tr>
                      <tr>
                        <td bgcolor="#FFFFFF" class="graytext">CodeLink :</td>
                        <td bgcolor="#FFFFFF"><textarea name="codes" cols="80" rows="15" class="editbar" id="codes"><?php echo $row_edigam['codes']; ?></textarea></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Date :</td>
                        <td bgcolor="#FFFFFF"><input name="daters" type="text" class="editbar" id="daters" value="<?php echo $row_edigam['daters']; ?>"/></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Category :</td>
                        <td bgcolor="#FFFFFF"><select name="cates" class="editbar" id="cates">
                          <option selected="selected" value="" <?php if (!(strcmp("", $row_edigam['cates']))) {echo "selected=\"selected\"";} ?>>Select Here</option>
                          <option value="action" <?php if (!(strcmp("action", $row_edigam['cates']))) {echo "selected=\"selected\"";} ?>>Action</option>
                          <option value="sports" <?php if (!(strcmp("sports", $row_edigam['cates']))) {echo "selected=\"selected\"";} ?>>Sports</option>
                          <option value="puzzle" <?php if (!(strcmp("puzzle", $row_edigam['cates']))) {echo "selected=\"selected\"";} ?>>Puzzle</option>
                          <option value="funny" <?php if (!(strcmp("funny", $row_edigam['cates']))) {echo "selected=\"selected\"";} ?>>Funny</option>
                        </select>                        </td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Keywords :</td>
                        <td bgcolor="#FFFFFF"><input name="keywds" type="text" class="editbar" id="keywds" value="<?php echo $row_edigam['keywds']; ?>" size="78" maxlength="40" /></td>
                      </tr>
                      <tr>
                    ...
                    <input name="ids" type="hidden" id="ids" value="<?php echo $row_edigam['ids']; ?>" />
...
<table width="1013" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="1013" bgcolor="#000000"><table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="12"></td>
      </tr>
    </table>
