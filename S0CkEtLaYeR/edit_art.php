...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "InsertTvChannels")) {
  $updateSQL = sprintf("UPDATE arti100blqs SET Title=%s, codes=%s, daters=%s, cates=%s, keywds=%s WHERE ids=%s",
...
$colname_ediart = "-1";
if (isset($_GET['ids'])) {
  $colname_ediart = $_GET['ids'];
}
mysql_select_db($database_Ublq, $Ublq);
$query_ediart = sprintf("SELECT * FROM arti100blqs WHERE ids = %s", GetSQLValueString($colname_ediart, "int"));
$ediart = mysql_query($query_ediart, $Ublq) or die(mysql_error());
$row_ediart = mysql_fetch_assoc($ediart);
$totalRows_ediart = mysql_num_rows($ediart);
    ...
    <td valign="top"><table width="1003" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="689" valign="top" bgcolor="#FFFFFF"><table width="888" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="840" height="28" class="headering_black" style="padding-left:6px;">Edit Articles :</td>
    ...
    <tr>
                  <td width="901" height="219" valign="top"><table width="896" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table border="0" cellpadding="4" cellspacing="0">
                      <tr>
                        <td width="76" height="33" bgcolor="#FFFFFF" class="graytext">Channel Name :</td>
                        <td width="303" bgcolor="#FFFFFF"><input name="Title" type="text" class="editbar" id="Title3" value="<?php echo $row_ediart['Title']; ?>" /></td>
                      </tr>
                      <tr>
                        <td bgcolor="#FFFFFF" class="graytext">CodeLink :</td>
                        <td bgcolor="#FFFFFF"><textarea name="codes" cols="80" rows="15" class="editbar" id="codes"><?php echo $row_ediart['codes']; ?></textarea></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Date :</td>
                        <td bgcolor="#FFFFFF"><input name="daters" type="text" class="editbar" id="daters" value="<?php echo $row_ediart['daters']; ?>"/></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Category :</td>
                        <td bgcolor="#FFFFFF"><select name="cates" class="editbar" id="cates">
                          <option value="news" selected="selected" <?php if (!(strcmp("news", $row_ediart['cates']))) {echo "selected=\"selected\"";} ?>>News</option>
                          <option value="entertainment" <?php if (!(strcmp("entertainment", $row_ediart['cates']))) {echo "selected=\"selected\"";} ?>>Entertainment</option>
                          <option value="movies" <?php if (!(strcmp("movies", $row_ediart['cates']))) {echo "selected=\"selected\"";} ?>>Movies</option>
                          <option value="games" <?php if (!(strcmp("games", $row_ediart['cates']))) {echo "selected=\"selected\"";} ?>>Games</option>
                        </select></td>
                      </tr>
                      <tr>
                        <td height="33" bgcolor="#FFFFFF" class="graytext">Keywords :</td>
                        <td bgcolor="#FFFFFF"><input name="keywds" type="text" class="editbar" id="keywds" value="<?php echo $row_ediart['keywds']; ?>" size="78" maxlength="40" /></td>
                      </tr>
                      <tr>
                    ...
                    <input name="ids" type="hidden" id="ids" value="<?php echo $row_ediart['ids']; ?>" />
